<h1>JavaScript --- Standard Curriculum ---</h1>
...
<p>このカリキュラムを受講するにあたりあらかじめ必ず「ドットインストール」でJavaScriptと<a href="https://dotinstall.com/lessons/basic_git">Git</a>について学んでおいてください。「Git」をクリックするとドットインストールへ遷移できます！
</p>
